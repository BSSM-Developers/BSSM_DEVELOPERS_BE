...
public class ApiUsageCommandService {
    ...
    public void delete(String apiId, Long apiTokenId, User currentUser) {
        ApiUsageId apiUsageId = ApiUsageId.create(apiId, apiTokenId);
        ApiUsage apiUsage = apiUsageRepository.findById(apiUsageId)
                .orElseThrow(ApiUsageNotFoundException::raise);
        ...
        Long apiUseReasonId = apiUsage.getApiUseReasonId();
        apiUsageRepository.delete(apiUsage);
        apiUseReasonRepository.deleteById(apiUseReasonId);
    }
