...
public class UrlBuilder {
    ...
    public String getGoogleLoginUrl(String codeChallenge) {
    ...
    public String getTokenUrl(String code, String codeVerifier) {
        String body = "grant_type=" + PkceUtil.enc("authorization_code")
                + "&code=" + PkceUtil.enc(code)
                + "&client_id=" + PkceUtil.enc(googleOauthProperties.getClientId())
                + "&redirect_uri=" + PkceUtil.enc(googleOauthProperties.getRedirectUri())
                + "&code_verifier=" + PkceUtil.enc(codeVerifier)
                + "&client_secret=" + PkceUtil.enc(googleOauthProperties.getSecretKey());
        return body;
    }
}
